...
func (q *Queries) CompletePurchase(ctx context.Context, id pgtype.UUID) error {
...
func (q *Queries) GetNotifyPurchaseDetails(ctx context.Context, id pgtype.UUID) (GetNotifyPurchaseDetailsRow, error) {
